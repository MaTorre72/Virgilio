...
`V114-T17` e` riaperto e il prossimo task univoco e` `V114-T17.1`.
...
| V114-T17.7 | TODO | P1 | Vista Attivita` leggibile | eventi locali e GUI | tabella Europe/Rome filtrabile per casella, esito, data ed errore, con messaggi comprensibili | dipende da T17.6; niente JSON ordinario o segreti |
