...
Nota operativa: nessun prossimo task operativo noto nella milestone `v1.1.4`.
...
| V114-T17 | DONE | P2 | GUI completa Caronte locale | `local_connector/`, `README.md`, `docs/SETUP_AND_TEST.md` | la GUI espone in tab le superfici operative CLI disponibili per stato, setup, account, Bucoliche, avvio, monitoraggio, manutenzione, automazione Win11 e diagnostica; le azioni senza CLI stabile sono visibili ma disabilitate con causa esplicita | wrapper sottile della CLI; niente logica parallela; niente segreti; azioni distruttive con conferma; lacune CLI residue documentate |
