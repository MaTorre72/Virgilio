...
| TODO | P1 | Eliminare `example.invalid` da dati operativi | manifest/state | fixture realistica; nessun placeholder esportato | Medio |
...
- 2026-06-29 — Creato governo autonomo; prossimo task: `Report pilota finale leggibile`.
