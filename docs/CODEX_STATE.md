...
- Task 0.0: chiuso
- Ultimo task chiuso noto: `V113-E4-T02 - Copiare solo file clean nel Limbo`
- Task corrente consigliato: `V113-E4-T03 - Creare record Da archiviare dal local connector`
- Massimo due successivi: `V113-E4-T04 - Scrivere evento Registro dal percorso locale`; `V113-E5-T01 - Form unico con inbox_id`
