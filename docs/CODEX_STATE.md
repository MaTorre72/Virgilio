...
- Task 0.0: chiuso
- Ultimo task chiuso noto: `V114-T10 - Setup CLI ready-to-run`
- Task corrente consigliato: `V114-T11 - GUI installazione locale fase 1`
- Massimo due successivi: `V114-T12 - Reset locale sicuro`; `V114-T13 - Migrazione installazione locale`
- Blocchi aperti: nessuno noto; backlog v1.1.4 aperto
- Ultimo smoke locale: `scripts/dev/smoke_local_connector.ps1` -> `OK` (`300 passed in 35.45s`)
