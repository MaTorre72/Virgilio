...
- Massimo due successivi: `GUI-U-E3-T12`, `GUI-U-E3-T13`
...
- Blocchi aperti: nessuno per `GUI-U-E3-T11`; build e smoke della distribuzione sono disponibili. Prima del prossimo collaudo va inoltre registrato il client OAuth Desktop centrale e fornito alla build tramite l'input locale ignorato gia` predisposto
