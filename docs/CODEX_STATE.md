...
- Task corrente di codice: `GUI-U-E2-T06 - Avvio, pausa e arresto`
- Task corrente consigliato: `GUI-U-E2-T06 - Avvio, pausa e arresto`
- Massimo due successivi: `GATE U-H2`, poi nessun task avviabile prima dell'esito umano
...
- Ultima suite locale: `local_connector\.venv\Scripts\python.exe -m pytest -o addopts='' --basetemp %TEMP%\virgilio-pytest-gui-e2-t05-full local_connector -q` -> `OK` (`399 passed`)
- Ultimo smoke locale: `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\dev\smoke_local_connector.ps1` -> `OK` (`399 passed`)
