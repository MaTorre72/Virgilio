...
- Fase corrente: `GUI-U-E3-T03 - Bucoliche e avvio Windows`
- Task 0.0: chiuso
...
- Task corrente di codice: `GUI-U-E3-T03 - Bucoliche e avvio Windows`
- Task corrente consigliato: `GUI-U-E3-T03 - Bucoliche e avvio Windows`
- Massimo due successivi: `GUI-U-E3-T04 - Manutenzione avanzata`
...
- Ultima suite locale: `local_connector\.venv\Scripts\python.exe -m pytest -o addopts='' --basetemp $env:TEMP\virgilio-pytest-gui-e3-t02-final local_connector -q` -> `OK` (`422 passed`)
- Ultimo smoke locale: `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\dev\smoke_local_connector.ps1` -> `OK` (`422 passed`)
