...
- Task corrente: `GUI-U-R03 - Collegamento dei servizi` (`FAIL` storico; `H-R03-02` pronto alla ripresa umana sulla build R03-R03)
- Successivo univoco: riprendere soltanto `H-R03-02` sulla build `8241325`, ID `7dcae8b2-5bd2-47b6-9c89-f53b4cf4c1ff`, senza ripetere le evidenze valide
...
- Blocchi aperti: gate umano `H-R03-02`. La build identificata R03-R03 e` pronta con client OAuth Desktop incorporato e smoke build/installer `PASS`; il flusso verifica e salva con una sola azione, riconcilia credenziali orfane con rollback e non presenta il campione come totale. Il disinstallatore diretto non ha completato la rimozione; Windows 11 `App installate` ha funzionato, difetto separato da trattare prima della release
