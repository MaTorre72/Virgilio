...
- Task 0.0: chiuso
- Ultimo task chiuso noto: `V114-T13 - Migrazione installazione locale`
- Task corrente consigliato: `V114-T14 - Avvio Caronte locale`
- Massimo due successivi: `V114-T15 - Installazione automatica Win11`; `V114-T16 - Documentazione utente finale`
- Blocchi aperti: nessuno noto; backlog v1.1.4 aperto
- Ultimo smoke locale: `scripts/dev/smoke_local_connector.ps1` -> `OK` (`303 passed in 48.21s`)
