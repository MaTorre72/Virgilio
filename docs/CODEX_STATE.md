...
- Task 0.0: chiuso
- Ultimo task chiuso noto: `V114-T14 - Avvio Caronte locale`
- Task corrente consigliato: `V114-T15 - Installazione automatica Win11`
- Massimo due successivi: `V114-T16 - Documentazione utente finale`
- Blocchi aperti: nessuno noto; backlog v1.1.4 aperto
- Ultima suite locale: `pytest local_connector` -> `OK` (`304 passed in 43.06s`)
- Ultimo smoke locale: `scripts/dev/smoke_local_connector.ps1` -> `OK` (`304 passed in 41.41s`)
