...
- Fase corrente: `GUI-U-E2 - Percorso verticale minimo`
- Task 0.0: chiuso
...
- Task corrente di codice: `GUI-U-E2-T03 - Configurazione semplificata di una casella`
- Task corrente consigliato: `GUI-U-E2-T03 - Configurazione semplificata di una casella`
- Massimo due successivi: `GUI-U-E2-T04`, poi `GUI-U-E2-T05`
...
- Ultima suite locale: `local_connector\.venv\Scripts\python.exe -m pytest -o addopts='' --basetemp %TEMP%\virgilio-pytest-gui-e2-t02-final local_connector -q` -> `OK` (`381 passed`)
- Ultimo smoke locale: `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\dev\smoke_local_connector.ps1` -> `OK` (`381 passed`)
