...
- Task corrente di codice: `GUI-U-E2-T02 - Wizard con schermate reali`
- Task corrente consigliato: `GUI-U-E2-T02 - Wizard con schermate reali`
- Massimo due successivi: `GUI-U-E2-T03`, poi `GUI-U-E2-T04`
...
- Ultima suite locale: `local_connector\.venv\Scripts\python.exe -m pytest -o addopts='' --basetemp %TEMP%\virgilio-pytest-gui-e2-t01-full-rerun local_connector -q` -> `OK` (`377 passed`)
- Ultimo smoke locale: `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\dev\smoke_local_connector.ps1` -> `OK` (`377 passed`)
