...
- Task corrente di codice: `GUI-U-E3-T14 - Registro e avvio guidati senza finestre tecniche`
- Task corrente consigliato: `GUI-U-E3-T14`
...
- Ultima suite locale: `local_connector\.venv\Scripts\python.exe -m pytest -o addopts='' --basetemp $env:TEMP\virgilio-pytest-gui-e3-t13-full local_connector -q` -> `OK` (`475 passed`)
- Ultimo smoke locale: `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\dev\smoke_local_connector.ps1` -> `OK` (`475 passed`)
