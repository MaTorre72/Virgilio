...
- Task 0.0: chiuso
- Ultimo task chiuso noto: `V114-T11 - GUI installazione locale fase 1`
- Task corrente consigliato: `V114-T12 - Reset locale sicuro`
- Massimo due successivi: `V114-T13 - Migrazione installazione locale`; `V114-T14 - Avvio Caronte locale`
- Blocchi aperti: nessuno noto; backlog v1.1.4 aperto
- Ultimo smoke locale: `scripts/dev/smoke_local_connector.ps1` -> `OK` (`300 passed in 22.09s`)
