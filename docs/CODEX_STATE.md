...
- Task 0.0: chiuso
- Ultimo task chiuso noto: `V114-T17.5 - Avvio e arresto non bloccanti`
- Task corrente consigliato: `V114-T17.6 - Home operativa`
- Massimo due successivi: `V114-T17.7 - Vista Attivita leggibile`; `V114-T17.8 - Impostazioni contestuali`
...
- Ultima suite locale: `pytest -o addopts='' --basetemp %TEMP%\virgilio-pytest-v114-t175-full local_connector -q` -> `OK` (`331 passed in 48.99s`)
- Ultimo smoke locale: `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\dev\smoke_local_connector.ps1` -> `OK` (`331 passed in 62.35s`)
