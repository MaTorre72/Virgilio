...
- Blocchi aperti: `GUI-U-E3-T09 = BLOCKED` richiede la decisione umana tra OAuth esclusivo e OAuth predefinito con password per app come fallback amministrato; `GUI-U-E3-T10` richiede decisione sulla responsabilita` di selezione del Registro Google
