...
- Task corrente di codice: `GUI-U-E1-T04 - Backend credenziali Windows`
- Task corrente consigliato: `GUI-U-E1-T04 - Backend credenziali Windows`
- Massimo due successivi: `GUI-U-E2-T01`, poi `GUI-U-E2-T02`
...
- Ultima suite locale: `local_connector\.venv\Scripts\python.exe -m pytest -o addopts='' --basetemp %TEMP%\virgilio-pytest-gui-e1-t03-full-final local_connector -q` -> `OK` (`366 passed`)
- Ultimo smoke locale: `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\dev\smoke_local_connector.ps1` -> `OK` (`366 passed`)
