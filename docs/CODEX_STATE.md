...
- Ultima readiness GAS: `docs/GAS_PUSH_REPORT_20260704.md` -> `GO`; il mirror e` stato riallineato in locale da `apps_script/src` e il push finale e` stato completato dopo il refresh auth esterno
