...
- Task corrente di codice: `GUI-U-E2-T01 - Nuova shell user_app`
- Task corrente consigliato: `GUI-U-E2-T01 - Nuova shell user_app`
- Massimo due successivi: `GUI-U-E2-T02`, poi `GUI-U-E2-T03`
...
- Ultima suite locale: `local_connector\.venv\Scripts\python.exe -m pytest -o addopts='' --basetemp %TEMP%\virgilio-pytest-gui-e1-t04-full local_connector -q` -> `OK` (`372 passed`)
- Ultimo smoke locale: `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\dev\smoke_local_connector.ps1` -> `OK` (`372 passed`)
