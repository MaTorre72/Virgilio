...
- Fase corrente: `GUI-U-E3-T02 - Impostazioni essenziali`
- Task 0.0: chiuso
...
- Task corrente di codice: `GUI-U-E3-T02 - Impostazioni essenziali`
- Task corrente consigliato: `GUI-U-E3-T02 - Impostazioni essenziali`
- Massimo due successivi: `GUI-U-E3-T03 - Bucoliche e avvio Windows`
...
- Ultima suite locale: `local_connector\.venv\Scripts\python.exe -m pytest -o addopts='' --basetemp $env:TEMP\virgilio-pytest-gui-e3-t01-full local_connector -q` -> `OK` (`414 passed`)
- Ultimo smoke locale: `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\dev\smoke_local_connector.ps1` -> `OK` (`414 passed`)
