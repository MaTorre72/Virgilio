...
- Task 0.0: chiuso
- Ultimo task chiuso noto: `V113-E4-T03 - Creare record Da archiviare dal local connector`
- Task corrente consigliato: `V113-E4-T04 - Scrivere evento Registro dal percorso locale`
- Massimo due successivi: `V113-E5-T01 - Form unico con inbox_id`; `V113-E6-T01 - Documentare i due profili operativi`
