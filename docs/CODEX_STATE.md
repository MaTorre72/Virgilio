...
- Task 0.0: chiuso
- Ultimo task chiuso noto: `V114-T03 - Modi operativi supportati`
- Task corrente consigliato: `V114-T04 - Configurazione multi-account neutra`
- Massimo due successivi: `V114-T05 - Secrets hardening locale`; `V114-T06 - Secrets e setup GAS`
