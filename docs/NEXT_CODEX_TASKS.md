...
Stato operativo corrente: backlog v1.1.3 attivo; chiuso `V113-E4-T04 - Scrivere evento Registro dal percorso locale`, prossima run da `V113-E5-T01 - Form unico con inbox_id`.
...
- Conseguenza: la prossima run puo` partire da `V113-E5-T01 - Form unico con inbox_id`.
