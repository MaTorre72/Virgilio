...
- Task corrente: `GUI-U-E2-T03 - Configurazione semplificata di una casella`, stato `READY`.
- Dipendenza soddisfatta: `GUI-U-E2-T02 = DONE`.
...
- Successivo dopo `DONE`: `GUI-U-E2-T04 - Multi-account`.
