...
- Task corrente: `GUI-U-E2-T02 - Wizard con schermate reali`, stato `READY`.
- Dipendenza soddisfatta: `GUI-U-E2-T01 = DONE`.
...
- Successivo dopo `DONE`: `GUI-U-E2-T03 - Configurazione semplificata di una casella`.
