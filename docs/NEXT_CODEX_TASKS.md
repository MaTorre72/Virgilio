...
- Esito corrente: `GUI-U-R03 - Collaudo umano unico della build operativa` = `IN_PROGRESS`. `H-R03-02` e `H-R03-03 = PASS` umano esplicito il 2026-07-24 sulla build `8241325`, ID `7dcae8b2-5bd2-47b6-9c89-f53b4cf4c1ff`; i due `FAIL` precedenti restano evidenza storica.
...
- Successivo univoco: eseguire soltanto `H-R03-04` sulla stessa build R03-R03 installata. Non ripetere avvio, Limbo, navigazione o collegamento delle caselle; il difetto separato del disinstallatore resta da pianificare prima della release.
