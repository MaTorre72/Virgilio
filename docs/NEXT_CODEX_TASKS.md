...
- Successivo univoco: produrre una sola build/installer identificata del commit R03-R02, con client OAuth Desktop protetto gia` predisposto, poi riprendere il collaudo umano da `H-R03-02`. Non ripetere avvio, Limbo e navigazione gia` acquisiti; non dichiarare `PASS` senza conferma umana.
