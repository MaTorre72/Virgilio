...
- Esito corrente: `GUI-U-R03 - Collaudo umano unico della build operativa` = `WAITING_HUMAN_REVIEW` sulla sola evidenza non registrata `H-R03-01`. `H-R03-02`--`H-R03-06 = PASS` umano; `R03-AC2`--`R03-AC5 = MET`.
...
- Successivo univoco: acquisire soltanto `H-R03-01 - Limbo reale`; non ripetere `H-R03-02`--`H-R03-06`. Il difetto separato del disinstallatore resta da pianificare prima della release.
