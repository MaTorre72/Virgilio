...
- Esito corrente: `GUI-U-R03 - Collaudo umano unico della build operativa` = `FAIL` su `H-R03-06`. `H-R03-02`--`H-R03-05 = PASS` umano sulla build `8241325`, ID `7dcae8b2-5bd2-47b6-9c89-f53b4cf4c1ff`; `R03-AC2`--`R03-AC4 = MET`.
...
- Correttivo finito proposto: `GUI-U-R03-R04 - Controllo automatico per utente`, con registrazione del worker congelato senza Task Scheduler, UAC o privilegi amministrativi e con pulizia in disinstallazione.
- Successivo univoco: attendere approvazione esplicita di `GUI-U-R03-R04`; non modificare codice e non ripetere evidenze. Il difetto separato del disinstallatore resta da pianificare prima della release.
