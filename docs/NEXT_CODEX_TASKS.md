...
Stato operativo corrente: backlog v1.1.3 attivo; chiuso `V113-E4-T02 - Copiare solo file clean nel Limbo`, prossima run da `V113-E4-T03 - Creare record Da archiviare dal local connector`.
...
- Conseguenza: la prossima run puo` partire da `V113-E4-T03 - Creare record Da archiviare dal local connector`.
