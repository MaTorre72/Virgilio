...
- Task corrente: `GUI-U-E1-T03 - Archivio credenziali astratto`, stato `READY`.
- Dipendenza soddisfatta: `GUI-U-E1-T02 = DONE`.
...
- Successivo dopo `DONE`: `GUI-U-E1-T04 - Backend credenziali Windows`.
