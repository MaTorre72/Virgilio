...
- Successivo univoco: produrre una sola build/installer identificata del commit R03-R03 con il client OAuth Desktop protetto gia` predisposto, poi riprendere `H-R03-02`. Non ripetere avvio, Limbo e navigazione; il difetto separato del disinstallatore resta da pianificare prima della release.
