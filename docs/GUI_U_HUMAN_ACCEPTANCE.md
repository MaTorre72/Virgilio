...
| `H-R03-06` Automatico | Attivazione/conferma/stato, disattivazione, persistenza e assenza di finestre o percorsi tecnici. | `FAIL` | Esito umano del 2026-07-24 sulla build R03-R03: `Attivazione non riuscita. Riprova da Windows.` e nessuna attivita pianificata creata. Lo screenshot mostra anche il Registro non configurato, prerequisito amministrativo distinto e non causa del fallimento Windows. Collaudo interrotto; proposta `GUI-U-R03-R04` in attesa di approvazione. |
